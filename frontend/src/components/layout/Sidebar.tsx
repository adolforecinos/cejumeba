...
const navItems: NavItem[] = [
  ...
  { to: '/estudiantes',   label: 'Estudiantes',     icon: <Users size={18} />,           roles: ['DIRECTOR','SECRETARIA','DOCENTE'] },
  ...
  { to: '/boletines',     label: 'Boletines',       icon: <Printer size={18} />,         roles: ['DIRECTOR','DOCENTE','SECRETARIA'] },
  { to: '/historial',     label: 'Historial',       icon: <History size={18} />,         roles: ['DIRECTOR','SECRETARIA','DOCENTE'] },
