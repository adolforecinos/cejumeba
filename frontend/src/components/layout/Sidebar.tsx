...
const navItems: NavItem[] = [
  ...
  { to: '/estudiantes',   label: 'Estudiantes',     icon: <Users size={18} />,           roles: ['DIRECTOR','SECRETARIA'] },
  { to: '/cursos',        label: 'Cursos',          icon: <BookOpen size={18} />,        roles: ['DIRECTOR','DOCENTE','SECRETARIA'] },
  { to: '/periodos',      label: 'Periodos',        icon: <Calendar size={18} />,        roles: ['DIRECTOR'] },
  { to: '/actividades',   label: 'Actividades',     icon: <ClipboardList size={18} />,   roles: ['DOCENTE'] },
  { to: '/notas',         label: 'Registro Notas',  icon: <FileText size={18} />,        roles: ['DOCENTE'] },
  { to: '/boletines',     label: 'Boletines',       icon: <Printer size={18} />,         roles: ['DIRECTOR','SECRETARIA'] },
  { to: '/historial',     label: 'Historial',       icon: <History size={18} />,         roles: ['DIRECTOR','SECRETARIA'] },
  { to: '/reportes',      label: 'Reportes',        icon: <BarChart3 size={18} />,       roles: ['DIRECTOR'] },
